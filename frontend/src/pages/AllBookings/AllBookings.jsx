...
class AllBookings extends Component {
    ...
    fetchAllBookings = () => {
        axios.get('https://project-2-vdwg.onrender.com/booking/getBookingDetails')
            .then((response) => {
    ...
    confirmBooking = (bookingId) => {
        axios.post(`https://project-2-vdwg.onrender.com/booking/confirmBooking/${bookingId}`)
            .then((response) => {
    ...
    deleteBooking = (bookingId) => {
        axios.delete(`https://project-2-vdwg.onrender.com/booking/deleteBooking/${bookingId}`)
            .then((response) => {
