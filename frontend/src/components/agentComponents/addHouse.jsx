          ...
          >
            ...
            <div className="bodyProperties">
              ...
              <Container className="custom-container">
                ...
                <Row>
                  ...
                  <Col>
                    <label htmlFor="no_of_bathrooms">Number of Bathrooms</label>
                    <br />
                    <input
                      type="number"
                ...
                <Row>
                  <Col>
                    <label htmlFor="land_size">Land Size(perches)</label>
                    <br />
                    <input
                      type="number"
                      name="land_size"
                  ...
                  <Col>
                    <label htmlFor="distance">Distance to town (KM)'</label>
                    <br />
                    <input
                      type="number"
                      name="distance"
            ...
            <div className="bodyProperties">
              ...
              <input
                ...
                onChange={this.handleInputChange}
              />
              <label htmlFor="LuxuryHouse">Luxury House</label>
              <br />
              <input
                type="radio"
                id="BudgetHouse"
                ...
                onChange={this.handleInputChange}
              />
              <label htmlFor="BudgetHouse">Budget House</label>
              <br />
              ...
              <input
                ...
                onChange={this.handleInputChange}
              />
              <label htmlFor="LuxuryHouse">Apartment</label>
              <br />
              <br />
            </div>
