      ...
      <div className="navbar">
        <nav>
          <ul className="nav__links">
            ...
            <li>
              <Link to="/displayHouses/Luxury House">Luxury House</Link>
            </li>
            <li>
              <Link to="/displayHouses/Budget House">Budget House</Link>
            </li>
            <li>
              <Link to="/displayHouses/Apartment">Apartment</Link>
            </li>
            <li>
